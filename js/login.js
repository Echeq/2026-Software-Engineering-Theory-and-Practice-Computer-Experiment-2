...
async function handleFormSubmit(event) {
  ...
  try {
    ...
    showMessage("Login successful. You can now redirect to the projects page.", "success");
    form.reset();
  } catch (error) {
...
async function loginUser(email, password) {
  // Update the base URL and endpoint after the backend team shares the API contract.
