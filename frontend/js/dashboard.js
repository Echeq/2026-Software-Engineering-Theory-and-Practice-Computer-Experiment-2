...
(() => {
  ...
  // src/dashboard.ts
  var THEME_STORAGE_KEY = "dashboard-theme";
  var MOBILE_SIDEBAR_BREAKPOINT = 960;
  var i18n = (key, values) => window.I18n?.t(key, values) || key;
  var currentUser = null;
  var userNameElement = null;
  var userAvatarElement = null;
  var greetingTitleElement = null;
  var greetingDateElement = null;
  var projectsMessageBox = null;
  var projectsListElement = null;
  var projectSortSelectElement = null;
  var newProjectButton = null;
  var logoutButton = null;
  var themeToggleButton = null;
  var sidebarToggleButton = null;
  var sidebarElement = null;
  var sidebarBackdropElement = null;
  var projectModalElement = null;
  var projectFormElement = null;
  var projectNameInput = null;
  var projectDescriptionInput = null;
  var projectFormMessageBox = null;
  var projectSubmitButton = null;
  var closeProjectModalButton = null;
  var cancelProjectModalButton = null;
  var projectSearchInput = null;
  var projectStatusInput = null;
  var projectLanguageInput = null;
  ...
  function cacheElements() {
    ...
    projectLanguageInput = document.getElementById("project-language-input");
  }
  ...
  function refreshGreetingBanner() {
    ...
    if (greetingTitleElement) {
      greetingTitleElement.textContent = displayName ? i18n("dashboard.greetingMorning", { name: displayName }) : i18n("dashboard.greetingMorningFallback");
    }
