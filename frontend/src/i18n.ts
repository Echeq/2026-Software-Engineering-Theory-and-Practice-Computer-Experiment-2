...
const translations: Record<Language, TranslationDictionary> = {
  en: {
    ...
    "projects.confirmCloseProject": "Close project \"{name}\"?",
    "projects.confirmReopenProject": "Reopen project \"{name}\"?",
    "projects.confirmDeleteProject": "Delete project \"{name}\"? This action cannot be undone.",
    "projects.projectClosed": "Project closed successfully.",
    "projects.projectReopened": "Project reopened successfully.",
    "projects.projectDeleted": "Project deleted successfully.",
    "projects.failedCloseProject": "Failed to close project.",
    ...
    "team.roleSoporte": "Support",
    "team.changeToManager": "Promote to Manager",
    "team.changeToSupport": "Promote to Support",
    "team.confirmChangeRole": "Promote {name} to Manager?",
    "team.confirmChangeToSupport": "Promote {name} to Support?",
    "team.roleChanged": "User role updated to Manager.",
    "team.roleChangedToSupport": "User role updated to Support.",
    "team.failedChangeRole": "Failed to change user role.",
  ...
  zh: {
    ...
    "projects.confirmCloseProject": "关闭项目 \"{name}\"？",
    "projects.confirmReopenProject": "重新打开项目 \"{name}\"？",
    "projects.confirmDeleteProject": "删除项目 \"{name}\"？此操作不可撤销。",
    "projects.projectClosed": "项目已关闭。",
    "projects.projectReopened": "项目已重新打开。",
    "projects.projectDeleted": "项目已删除。",
    "projects.failedCloseProject": "关闭项目失败。",
    ...
    "team.roleMember": "成员",
    "team.changeToManager": "提升为管理员",
    "team.changeToSupport": "提升为支持",
    "team.confirmChangeRole": "确定将 {name} 提升为管理员？",
    "team.confirmChangeToSupport": "确定将 {name} 提升为支持？",
    "team.roleChanged": "用户角色已更新为管理员。",
    "team.roleChangedToSupport": "用户角色已更新为支持。",
    "team.failedChangeRole": "更改用户角色失败。",
  ...
  es: {
    ...
    "projects.confirmCloseProject": "¿Cerrar proyecto \"{name}\"?",
    "projects.confirmReopenProject": "¿Reabrir proyecto \"{name}\"?",
    "projects.confirmDeleteProject": "¿Eliminar proyecto \"{name}\"? Esta acción no se puede deshacer.",
    "projects.projectClosed": "Proyecto cerrado correctamente.",
    "projects.projectReopened": "Proyecto reabierto correctamente.",
    "projects.projectDeleted": "Proyecto eliminado correctamente.",
    "projects.failedCloseProject": "Error al cerrar el proyecto.",
    "projects.failedDeleteProject": "Error al eliminar el proyecto.",
    ...
    "team.roleManager": "Manager",
    "team.roleMember": "Member",
    "team.changeToManager": "Ascender a Manager",
    "team.changeToSupport": "Ascender a Support",
    "team.confirmChangeRole": "¿Ascender a {name} a Manager?",
    "team.confirmChangeToSupport": "¿Ascender a {name} a Support?",
    "team.roleChanged": "Rol actualizado a Manager.",
    "team.roleChangedToSupport": "Rol actualizado a Support.",
    "team.failedChangeRole": "Error al cambiar el rol.",
  ...
  ru: {
    ...
    "projects.confirmCloseProject": "Закрыть проект \"{name}\"?",
    "projects.confirmReopenProject": "Открыть проект \"{name}\"?",
    "projects.confirmDeleteProject": "Удалить проект \"{name}\"? Это действие необратимо.",
    "projects.projectClosed": "Проект закрыт.",
    "projects.projectReopened": "Проект открыт.",
    "projects.projectDeleted": "Проект удалён.",
    "projects.failedCloseProject": "Не удалось закрыть проект.",
    ...
    "team.roleSoporte": "Сопровождение",
    "team.roleManager": "Менеджер",
    "team.roleMember": "Участник",
    "team.changeToManager": "Назначить менеджером",
    "team.changeToSupport": "Назначить поддержкой",
    "team.confirmChangeRole": "Назначить {name} менеджером?",
    "team.confirmChangeToSupport": "Назначить {name} поддержкой?",
    "team.roleChanged": "Роль изменена на менеджера.",
    "team.roleChangedToSupport": "Роль изменена на поддержку.",
