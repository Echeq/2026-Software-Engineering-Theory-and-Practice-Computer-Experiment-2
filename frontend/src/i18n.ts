...
const translations: Record<Language, TranslationDictionary> = {
  en: {
    ...
    "tasks.selectProjectTitle": "Select a project",
    "tasks.selectProjectText": "Choose a project from the dropdown to view its tasks.",
  ...
  zh: {
    ...
    "tasks.selectProjectTitle": "选择一个项目",
    "tasks.selectProjectText": "从下拉列表中选择一个项目以查看其任务。",
  ...
  es: {
    ...
    "tasks.selectProjectTitle": "Selecciona un proyecto",
    "tasks.selectProjectText": "Elige un proyecto del menú desplegable para ver sus tareas.",
  ...
  ru: {
    ...
    "tasks.selectProjectTitle": "Выберите проект",
    "tasks.selectProjectText": "Выберите проект из списка, чтобы просмотреть его задачи.",
...
Object.assign(translations.ru, {
  ...
  "login.success": "Вход выполнен. Переход в панель управления...",
  ...
  "login.validation.emailRequired": "Укажите электронную почту.",
  "login.validation.emailInvalid": "Введите корректный адрес электронной почты.",
  "login.validation.passwordRequired": "Укажите пароль.",
  "login.validation.passwordShort": "Пароль должен содержать минимум 6 символов.",
  "signup.title": "Создать аккаунт",
  "signup.subtitle": "Создайте аккаунт, чтобы начать управлять проектами и задачами.",
  ...
  "signup.success": "Аккаунт создан. Переход на страницу входа...",
  ...
  "signup.validation.nameRequired": "Укажите полное имя.",
  "signup.validation.nameShort": "Имя должно содержать минимум 2 символа.",
  "signup.validation.emailRequired": "Укажите электронную почту.",
  "signup.validation.emailInvalid": "Введите корректный адрес электронной почты.",
  "signup.validation.passwordRequired": "Укажите пароль.",
  "signup.validation.passwordShort": "Пароль должен содержать минимум 6 символов.",
