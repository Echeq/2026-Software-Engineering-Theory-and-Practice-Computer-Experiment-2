...
const translations: Record<Language, TranslationDictionary> = {
  en: {
    ...
    "projects.failedDeleteProject": "Failed to delete project.",
    "tasks.pageTag": "Tasks",
  ...
  zh: {
    ...
    "dashboard.statisticsSubtitle": "快速查看此设备上项目和任务进度的可视化摘要。",
    ...
    "projects.failedDeleteProject": "删除项目失败。",
    "tasks.pageTag": "任务",
  ...
  es: {
    ...
    "projects.confirmDelete": "¿Eliminar el proyecto \"{name}\"?",
    "projects.projectDeleted": "Proyecto eliminado correctamente.",
    "projects.failedDeleteProject": "No se pudo eliminar el proyecto.",
  ...
  ru: {
    ...
    "projects.confirmDelete": "Удалить проект \"{name}\"?",
    "projects.projectDeleted": "Проект успешно удалён.",
    "projects.failedDeleteProject": "Не удалось удалить проект.",
...
Object.assign(translations.ru, {
  ...
  "signup.emailPlaceholder": "user@example.com",
...
Object.assign(translations.en, {
  "settings.subtitle": "Adjust your profile, account security, and appearance preferences.",
  "settings.stateText": "Profile and password changes are saved to your account.",
  "settings.profileText": "Edit the name and email saved on your account.",
  "settings.profileConfirmTitle": "Confirm profile changes",
  "settings.profileConfirmSubtitle": "Save your updated name and email.",
  "settings.profileUpdated": "Profile updated successfully.",
  "settings.profileValidation.required": "Name and email are required.",
  "settings.profileValidation.nameShort": "Name must be at least 2 characters.",
  "settings.profileValidation.emailInvalid": "Enter a valid email address.",
  "settings.accountText": "Manage account security actions.",
  "settings.changePasswordHint": "Change the password for your account.",
  "settings.passwordModalSubtitle": "Update your account password.",
  "settings.passwordValidation.newTooShort": "New Password must be at least 6 characters.",
  "settings.passwordValidation.newDifferent": "New Password must be different from the current password.",
  "settings.passwordValidation.currentIncorrect": "Current password is incorrect.",
  "settings.passwordSuccessRelogin": "Password changed successfully. Please log in again.",
  "settings.accountHint": "This action updates your account password.",
  "settings.cancel": "Cancel",
  "common.error": "Something went wrong."
});

Object.assign(translations.zh, {
  "settings.subtitle": "管理你的个人资料、账户安全和外观偏好。",
  "settings.stateText": "个人资料和密码更改会保存到账户。",
  "settings.profileText": "编辑账户中保存的姓名和邮箱。",
  "settings.profileConfirmTitle": "确认资料更改",
  "settings.profileConfirmSubtitle": "保存更新后的姓名和邮箱。",
  "settings.profileConfirmCancel": "取消",
  "settings.profileConfirmConfirm": "确认",
  "settings.profileUpdated": "个人资料已更新。",
  "settings.profileValidation.required": "姓名和邮箱为必填项。",
  "settings.profileValidation.nameShort": "姓名至少需要 2 个字符。",
  "settings.profileValidation.emailInvalid": "请输入有效的邮箱地址。",
  "settings.accountText": "管理账户安全操作。",
  "settings.changePasswordHint": "更改你的账户密码。",
  "settings.passwordModalTitle": "修改密码",
  "settings.passwordModalSubtitle": "更新你的账户密码。",
  "settings.passwordModalClose": "关闭修改密码对话框",
  "settings.currentPassword": "当前密码",
  "settings.newPassword": "新密码",
  "settings.confirmNewPassword": "确认新密码",
  "settings.passwordSave": "保存",
  "settings.passwordValidation.currentRequired": "当前密码为必填项。",
  "settings.passwordValidation.newTooShort": "新密码至少需要 6 个字符。",
  "settings.passwordValidation.newDifferent": "新密码必须与当前密码不同。",
  "settings.passwordValidation.currentIncorrect": "当前密码不正确。",
  "settings.passwordValidation.confirmMismatch": "确认密码必须与新密码一致。",
  "settings.passwordSuccessRelogin": "密码修改成功。请重新登录。",
  "settings.accountHint": "此操作会更新你的账户密码。",
  "settings.cancel": "取消",
  "common.error": "出现错误。"
});

Object.assign(translations.es, {
  "settings.subtitle": "Gestiona tu perfil, seguridad de cuenta y preferencias de apariencia.",
  "settings.stateText": "Los cambios de perfil y contraseña se guardan en tu cuenta.",
  "settings.profileText": "Edita el nombre y correo guardados en tu cuenta.",
  "settings.profileConfirmTitle": "Confirmar cambios del perfil",
  "settings.profileConfirmSubtitle": "Guardar el nombre y correo actualizados.",
  ...
  "settings.profileValidation.required": "El nombre y el correo son obligatorios.",
  "settings.profileValidation.nameShort": "El nombre debe tener al menos 2 caracteres.",
  "settings.profileValidation.emailInvalid": "Introduce un correo válido.",
  "settings.accountText": "Gestiona acciones de seguridad de la cuenta.",
  "settings.changePasswordHint": "Cambia la contraseña de tu cuenta.",
  "settings.passwordModalTitle": "Cambiar contraseña",
  "settings.passwordModalSubtitle": "Actualiza la contraseña de tu cuenta.",
  "settings.passwordModalClose": "Cerrar diálogo de cambio de contraseña",
  ...
  "settings.passwordValidation.currentRequired": "La contraseña actual es obligatoria.",
  "settings.passwordValidation.newTooShort": "La nueva contraseña debe tener al menos 6 caracteres.",
  "settings.passwordValidation.newDifferent": "La nueva contraseña debe ser diferente de la actual.",
  "settings.passwordValidation.currentIncorrect": "La contraseña actual es incorrecta.",
  "settings.passwordValidation.confirmMismatch": "La confirmación debe coincidir con la nueva contraseña.",
  "settings.passwordSuccessRelogin": "Contraseña cambiada correctamente. Inicia sesión de nuevo.",
  "settings.accountHint": "Esta acción actualiza la contraseña de tu cuenta.",
  "settings.cancel": "Cancelar",
  "common.error": "Algo salió mal."
});

Object.assign(translations.ru, {
  "settings.subtitle": "Управляйте профилем, безопасностью аккаунта и внешним видом.",
  "settings.stateText": "Изменения профиля и пароля сохраняются в аккаунте.",
  "settings.profileText": "Редактируйте имя и эл. почту, сохранённые в аккаунте.",
  "settings.profileConfirmTitle": "Подтвердите изменения профиля",
  "settings.profileConfirmSubtitle": "Сохранить обновлённые имя и эл. почту.",
  "settings.profileConfirmCancel": "Отмена",
  "settings.profileConfirmConfirm": "Подтвердить",
  "settings.profileUpdated": "Профиль обновлён.",
  "settings.profileValidation.required": "Имя и эл. почта обязательны.",
  "settings.profileValidation.nameShort": "Имя должно содержать не менее 2 символов.",
  "settings.profileValidation.emailInvalid": "Введите корректный email.",
  "settings.accountText": "Управляйте действиями безопасности аккаунта.",
  "settings.changePasswordHint": "Измените пароль аккаунта.",
  "settings.passwordModalSubtitle": "Обновите пароль аккаунта.",
  "settings.passwordValidation.newTooShort": "Новый пароль должен содержать не менее 6 символов.",
  "settings.passwordValidation.newDifferent": "Новый пароль должен отличаться от текущего.",
  "settings.passwordValidation.currentIncorrect": "Текущий пароль неверный.",
  "settings.passwordSuccessRelogin": "Пароль изменён. Войдите снова.",
  "settings.accountHint": "Это действие обновляет пароль аккаунта.",
